...
from ar6_ch6_rcmipfigs.notebooks.fig6_12_and_ts15_spm2.utils_hist_att.ch4_forcing_AR6 import ch4_forcing_AR6
from ar6_ch6_rcmipfigs.notebooks.fig6_12_and_ts15_spm2.utils_hist_att.co2_forcing_AR6 import co2_forcing_AR6
from ar6_ch6_rcmipfigs.notebooks.fig6_12_and_ts15_spm2.utils_hist_att.n2o_forcing_AR6 import n2o_forcing_AR6
...
def main(plot=False):
    ...
    dtype = 'U12' + ', f8' * ncols
    data = np.genfromtxt(INPUT_DATA_DIR / 'input_from_bill_collins/attribution_input.csv', delimiter=',',
                         filling_values=0,
                         names=True, dtype=(dtype))
    data_sd = np.genfromtxt(INPUT_DATA_DIR / 'input_from_bill_collins/attribution_input_sd.csv', delimiter=',',
                            filling_values=0,
                            names=True, dtype=(dtype))
    rfo3 = data['o3_rf']
